  ...
  module Concerns
    class CheckSpam
      ...
      def run
        ...
        ban_regex = /(porn|sexy|sex|girls|chicas|for the night|pasar la noche|порно|порнография|порнуха|порнушка|affiliate|marketing|bitcoin|investieren|tinyurl|Прокип|Андрей|продукт|объявлений|Размещение)/i
